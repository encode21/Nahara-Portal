...
function mapWargaWithIuran(
  wargaList: WargaWithIuranRows[],
  bulanIni: string,
): WargaWithIuran[] {
...
export default async function DashboardPage() {
  ...
  const totalPemasukan = kasEntries
    .filter((e) => e.type === "pemasukan")
    .reduce((s, e) => s + e.amount, 0);
  const totalPengeluaran = kasEntries
  ...
  const emergencies = (emergencyRes.data ?? []) as EmergencyIncident[];
